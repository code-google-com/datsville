...
// Date:         Tue Dec 27 20:25:16 2011
// Input file:   W:\JA2\mecha\povray\road_cross.ldr
// Title:        Baseplate 32 x 32 Road 7-Stud Crossroads with Crosswalk Pattern
...
// Commandline:  "C:\Programs Windows\l3p14beta\l3p.exe" W:\JA2\mecha\povray\road_cross.ldr -o -ic -il -ibmecha.inc
...
//// Model road_cross.ldr
#ifndef (road__cross_dot_ldr)
#declare road__cross_dot_ldr = #if (L3Quality = 0) box { <-320,0,-320>, <320,0,320> } #else union {
...
#end
#end // ifndef (road__cross_dot_ldr)
...
//// ModelObject road_cross.ldr
object { road__cross_dot_ldr material { L3Color7 } rotate	y * 360 * clock }
