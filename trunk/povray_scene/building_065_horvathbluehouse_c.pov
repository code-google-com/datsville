...
// Commandline:  "C:\Programs Windows\l3p14beta\l3p.exe" W:\LDraw\datsville\google_code\building_065_horvathbluehouse.mpd building_065_horvathbluehouse_c.pov -o -cg0,90,0 -lg45,0,0
...
camera {
	...
	right    -L3AspectRatio*x
		...
		scale    L3OrthoScale
	#else
		#declare L3LookAt = <0,-213,4.1638e-014>; // Calculated (not -cla)
		#declare L3Location = <680,-213,-0>;
...
//// Lights
light_source {
	<0,-688.833,-480.833>  // Latitude,Longitude,Radius: 45,0,680
