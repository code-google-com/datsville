...
// Commandline:  "C:\Programs Windows\l3p14beta\l3p.exe" W:\LDraw\datsville\google_code\building_065_horvathbluehouse.mpd building_065_horvathbluehouse_d.pov -o -cg90,0,0 -lg45,0,0
...
camera {
	...
	right    -L3AspectRatio*x
		...
		#declare L3OrthoScale = (1+L3PercentageBack/100.0)*560.005;
		#declare L3Location = L3LookAt - 2000*<-0,1,1.74437e-005>;
		location L3Location
		scale    L3OrthoScale
	#else
		#declare L3LookAt = <-0,-208,0.00118747>; // Calculated (not -cla)
		#declare L3Location = <-0,-976,-0.0122093>;
...
//// Lights
light_source {
	<0,-751.058,-543.058>  // Latitude,Longitude,Radius: 45,0,768
