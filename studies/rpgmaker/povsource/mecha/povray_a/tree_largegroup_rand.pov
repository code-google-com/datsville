...
// Date:         Sun Jan 01 21:00:53 2012
// Input file:   W:\mecha\povray\tree_largegroup_rand.ldr
// Title:        Untitled
...
// Commandline:  "C:\Programs Windows\l3p14beta\l3p.exe" W:\mecha\povray\tree_largegroup_rand.ldr -o -ic -il -ibmecha.inc
...
//// Model tree_largegroup_rand.ldr
#ifndef (tree__largegroup__rand_dot_ldr)
#declare tree__largegroup__rand_dot_ldr = union {
// Untitled
// Name: tree_largegroup_rand.ldr
// Author: Michael Horvath
// Unofficial Model
// ROTATION CENTER 0 0 0 1 "Custom"
// ROTATION CONFIG 0 0
	// 1 2  10 -8 20  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
	...
	// 1 2  -300 -8 -20  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-300,-8,-20>
		material { L3Color2 }
	}
	// 1 2  340 -8 -70  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,340,-8,-70>
		material { L3Color2 }
	}
	// 1 2  0 -8 -300  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,0,-8,-300>
		material { L3Color2 }
	}
	// 1 2  130 -8 -300  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,130,-8,-300>
		material { L3Color2 }
	}
	// 1 2  -10 -8 -450  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-10,-8,-450>
		material { L3Color2 }
	}
	// 1 2  -180 -8 -350  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-180,-8,-350>
		material { L3Color2 }
	}
	// 1 2  -260 -8 -150  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-260,-8,-150>
		material { L3Color2 }
	}
	// 1 2  -430 -8 -70  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  -280 -8 150  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-280,-8,150>
		material { L3Color2 }
	}
	// 1 2  -430 -8 110  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-430,-8,110>
		material { L3Color2 }
	}
	// 1 2  -300 -8 290  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-300,-8,290>
		material { L3Color2 }
	}
	// 1 2  -170 -8 420  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-170,-8,420>
		material { L3Color2 }
	}
	// 1 2  180 -8 460  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,180,-8,460>
		material { L3Color2 }
	}
	// 1 2  290 -8 280  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,290,-8,280>
		material { L3Color2 }
	}
	// 1 2  440 -8 110  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,440,-8,110>
		material { L3Color2 }
	}
	// 1 2  460 -8 -160  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  340 -8 -280  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,340,-8,-280>
		material { L3Color2 }
	}
	// 1 2  160 -8 -430  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  -160 -8 -470  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-160,-8,-470>
		material { L3Color2 }
	}
	// 1 2  -320 -8 -280  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-320,-8,-280>
		material { L3Color2 }
	}
	// 1 2  -480 -8 -180  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-480,-8,-180>
		material { L3Color2 }
	}
	// 1 2  -130 -8 290  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-130,-8,290>
		material { L3Color2 }
	}
	// 1 2  -10 -8 440  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-10,-8,440>
		material { L3Color2 }
	}
	// 1 2  120 -8 330  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,120,-8,330>
		material { L3Color2 }
	}
	// 1 2  320 -8 140  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,320,-8,140>
		material { L3Color2 }
	}
	// 1 2  500 -8 0  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,500,-8,0>
		material { L3Color2 }
	}
	// 1 2  220 -8 -180  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  10 -8 270  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,10,-8,270>
		material { L3Color2 }
	}
	// 1 2  140 -8 160  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,140,-8,160>
		material { L3Color2 }
	}
	// 1 2  160 -8 20  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  -20 -8 140  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  -140 -8 140  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-140,-8,140>
		material { L3Color2 }
	}
	// 1 2  -200 -8 20  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  -60 -8 -80  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
		matrix <1,0,0,0,1,0,0,0,1,-60,-8,-80>
		material { L3Color2 }
	}
	// 1 2  -70 -8 -200  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
	...
	// 1 2  100 -8 -110  1 0 0  0 1 0  0 0 1 688.dat
	object {
		_688_dot_dat
		matrix <1-L3SW/93.66,0,0,0,1-L3SW/280,0,0,0,1-L3SW/94,0,L3SW/-2.12121,0>
...
#end // ifndef (tree__largegroup__rand_dot_ldr)


//// ModelData
#declare L3ModelBBoxMin = <-526.83,-280,-517>;
#declare L3ModelBBoxMax = <546.83,0,507>;
#declare L3ModelBBoxCenter = (L3ModelBBoxMin+L3ModelBBoxMax)/2; // <10,-140,-5>
#declare L3ModelBBoxSize = L3ModelBBoxMax-L3ModelBBoxMin; // <1073.66,280,1024>
#declare L3FloorY = L3ModelBBoxMax.y;

//// ModelObject tree_largegroup_rand.ldr
object { tree__largegroup__rand_dot_ldr }
