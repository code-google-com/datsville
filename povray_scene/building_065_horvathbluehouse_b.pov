...
// Commandline:  "C:\Programs Windows\l3p14beta\l3p.exe" W:\LDraw\datsville\google_code\building_065_horvathbluehouse.mpd building_065_horvathbluehouse_b.pov -o -cg0,0,0 -lg45,0,0
...
camera {
	...
	right    -L3AspectRatio*x
		...
		#declare L3OrthoScale = (1+L3PercentageBack/100.0)*416;
		#declare L3Location = L3LookAt - 2000*<-0,0,1>;
		location L3Location
		scale    L3OrthoScale
	#else
		#declare L3LookAt = <-0,-213,0>; // Calculated (not -cla)
		#declare L3Location = <-0,-213,-686>;
...
//// Lights
light_source {
	<0,-693.075,-485.075>  // Latitude,Longitude,Radius: 45,0,686
